...
// Function to create basic HTML structure for each route
function createBasicHTML(route) {
...
<head>
  ...
  <link rel="canonical" href="https://alt.run${route === '/' ? '' : route}">
...
async function prerenderPages() {
  ...
  for (const route of staticRoutes) {
    ...
    try {
      // Create basic HTML for the route
      const html = createBasicHTML(route);
  ...
  // Create a basic placeholder for running plans
  ...
  const placeholderHtml = createBasicHTML('/running-plans/plan/placeholder');
